...
function App() {
  ...
  return (
      <>
          ...
          <div>Часто маршруты включают монастыри🙂. Но наши экскурсии не по монастырям — это путешествия по самым живописным уголкам Армении. Просто так сложилось, что монастыри часто строили именно там, где особенно красиво и спокойно. Так что природа, горы, виды — всё это в приоритете.
          </div>
